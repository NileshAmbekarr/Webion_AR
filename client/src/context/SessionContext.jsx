...
const VALID_TRANSITIONS = {
  ...
  [SESSION_STATES.SELLER_PREPARING]: [SESSION_STATES.SCANNING, SESSION_STATES.IDLE],
  [SESSION_STATES.SCANNING]: [SESSION_STATES.COUNTING_DOWN, SESSION_STATES.SELLER_PREPARING, SESSION_STATES.IDLE],
  [SESSION_STATES.COUNTING_DOWN]: [SESSION_STATES.SCANNING, SESSION_STATES.PROCESSING, SESSION_STATES.IDLE],
